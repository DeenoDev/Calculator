const bodyClass = "bg-purple-900 bg-gradient-to-br from blue-300 bg-opacity-25";
...
const previousNumberClass = "flex max-w-lg h-1/3 pb-5 pt-1 text-gray-900 font-semibold px-2 border border-black hover:border-gray-500 rounded";
...
const currentNumber = documnent.querySelector('.currentNumber');
